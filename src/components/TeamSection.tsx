  ...
  return (
    <section id="team" className="py-32 px-6 relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {/* Founders */}
        <div className="grid sm:grid-cols-2 gap-8 mb-8 items-stretch">
          <FadeInSection delay={0.1} className="h-full">
            <div className="glass p-8 text-center group transition-all duration-300 hover:translate-y-[-4px] h-full flex flex-col">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-accent/20 to-accent/5 mx-auto mb-6 flex items-center justify-center shrink-0">
              ...
              <p className="text-slate-500 text-xs leading-relaxed text-left flex-1">
                AIエージェント組織と協働し、自社サービスの発想・設計から開発・運用までを AI 駆動で推進。AEGIS OSS の設計・開発も手がける。
              </p>
            </div>
          </FadeInSection>
