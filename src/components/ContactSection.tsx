...
export default function ContactSection() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const subject = encodeURIComponent(`【AJARAご相談】${inquiryType} - ${name}`);
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <FadeInSection delay={0.1}>
            {!submitted ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="inquiry-type" className="block text-sm text-slate-400 mb-2">
                  ...
                  >
                    ...
                    <option value="AIエージェントシステム開発" className="bg-navy-dark">
                      AIエージェントシステム開発
                    </option>
                    <option value="ラピッドプロトタイピング" className="bg-navy-dark">
                      ラピッドプロトタイピング
                    </option>
                    <option value="その他のご相談" className="bg-navy-dark">
                      その他のご相談
                    </option>
                  </select>
                </div>
          ...
          <FadeInSection delay={0.2}>
            <div className="space-y-8">
              ...
              <div className="glass p-6 transition-all duration-300">
                <h3 className="text-sm text-accent tracking-wider uppercase mb-3">Location</h3>
              ...
              <div className="glass p-6 transition-all duration-300">
                <h3 className="text-sm text-accent tracking-wider uppercase mb-3">対応体制</h3>
