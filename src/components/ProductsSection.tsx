...
const achievements = [
  ...
  },
  {
    ...
    description:
      "私たちが内部開発・運用するAIエージェント基盤のオープンソース版。マルチエージェント設計のコアとなるフレームワークを公開しています。実際の開発プロセスで稼働しているのは非公開の AEGIS OS であり、本リポジトリはその知見をもとにした OSS 実装です。",
    metrics: [
      { value: "OSS", label: "公開形態" },
      { value: "GitHub", label: "ホスティング" },
      { value: "MIT", label: "ライセンス" },
    ],
    tags: ["Open Source", "Multi-Agent", "AI Framework", "MIT License"],
    gradient: "from-slate-400/15 to-transparent",
    href: "https://aegis-oss.vercel.app/",
  },
  {
    category: "開発手法",
    title: "AI 駆動開発",
    subtitle: "AI-Driven Development",
    description:
      "少数精鋭のエンジニアとAIエージェント組織が協働し、通常の大規模チームに匹敵する開発を実現。仮説検証型のアプローチとAIによる分析・コードレビュー・品質管理の自動化で、スピードと品質を両立しています。",
    metrics: [
      { value: "少数", label: "エンジニア" },
