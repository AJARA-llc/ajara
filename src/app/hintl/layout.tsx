  ...
  "@graph": [
    {
      "@type": "WebApplication",
      "name": "hintl",
      "description": "健康・美容などの選択を公開研究から比較できるエビデンスベースの意思決定エンジン。全記事を「結論→どんな研究？→専門的には」の3層構造で構成し、研究用語にはタップで表示されるやさしい説明を付ける。1分の無料診断で研究報告のある選択肢を確認できる。睡眠・メンタル・栄養・脳・集中・仕事・美容の6ジャンルに対応。2026年9月1日に正式リリース。",
      "url": "https://hintl.net",
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "健康・美容などの選択を「広告ではなく公開研究」から比較できる、エビデンスベースの意思決定エンジンです。全記事を「結論→どんな研究？→専門的には」の3層構造で構成し、研究用語にはタップで表示されるやさしい説明を付けています。1分の無料診断で研究報告のある選択肢を確認できます。2026年9月1日に正式リリースしました。",
          },
        },
        {
          "@type": "Question",
