...
const FAQS = [
  {
    q: "hintl はどんなサービスですか？",
    a: "健康・美容などの選択を「広告ではなく公開研究」から比較できる、エビデンスベースの意思決定エンジンです。全記事を「結論→どんな研究？→専門的には」の3層構造で構成し、研究用語にはタップで表示されるやさしい説明を付けています。1分の無料診断で研究報告のある選択肢を確認できます。2026年8月28日に正式リリースしました。",
  },
  {
    q: "料金はかかりますか？",
    ...
    <div style={{ background: "#ffffff", color: TEXT, minHeight: "100vh", fontFamily: font }}>
      ...
      >
        <p style={{ fontSize: "13px", color: TEXT, margin: 0, lineHeight: 1.6 }}>
          ...
          hintl は <strong>2026年8月28日</strong> に正式リリースしました。
